...
const service = getService("sua-may-lanh")!;

export const Route = createFileRoute("/sua-may-lanh")({
  head: () => ({
    ...pageHead({
      title: "Sửa máy lạnh tại nhà – Có mặt nhanh, báo giá trước | Điện Lạnh Việt Nam",
      description: "Dịch vụ sửa máy lạnh tại nhà: máy lạnh không lạnh, chảy nước, kêu to, báo lỗi. Kiểm tra rõ nguyên nhân và báo giá trước khi sửa.",
      path: "/sua-may-lanh",
    }),
    scripts: [
      { type: "application/ld+json", children: JSON.stringify(serviceSchema(service.title, "Dịch vụ sửa máy lạnh tại nhà: máy lạnh không lạnh, chảy nước, kêu to, báo lỗi. Kiểm tra rõ nguyên nhân và báo giá trước khi sửa.")) },
      {
        ...
        children: JSON.stringify(
          breadcrumbSchema([
            ...
            { name: service.title, item: "/sua-may-lanh" },
          ]),
        ),
      },
